Type the following commands to run Fortify Static Code Analyzer on source.asp and sink.asp:
...
have been validated as "safe" because it simply uses them to access a database
